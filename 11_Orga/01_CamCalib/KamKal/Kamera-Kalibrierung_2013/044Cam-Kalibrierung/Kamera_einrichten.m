...
while(auswahl~=4)   %Einstellen des Video Source Objektes
    ...
    disp(['Drücken Sie 1 um die Helligkeit einzustellen. Aktueller Wert: ',num2str(Brightness)]);
    disp(['Drücken Sie 2 um den Kontrast einzustellen.   Aktueller Wert: ',num2str(Contrast)]);
    disp(['Drücken Sie 3 um die Belichtung einzustellen.	Aktueller Wert: ',num2str(Exposure)]);
    disp('Drücken Sie 4, wenn sie mit den Video Source Objekt Einstellungen fertig sind.');
    ...
    switch auswahl
        case 1
            ...
            while(flag)   %Einstellen der Helligkeit
                ...
                disp('Drücken Sie "+" um den Wert um 1 und "#" um den Wert um 10 zu erhöhen.');
                disp('Drücken Sie "-" um den Wert um 1 und "." um den Wert um 10 zu verringern.');
        ...
        case 3
            ...
            while(flag)   %Einstellen der Belichtung
                ...
                clc;
                disp('Einstellen des Kontrastes (Das Figure muss dazu im Vordergrund stehen).');
                disp('Drücken Sie "+" um den Wert um 1 zu erhöhen.');
                disp('Drücken Sie "-" um den Wert um 1 zu verringern.');
                disp('Drücken Sie "r", wenn Sie fertig sind.');
